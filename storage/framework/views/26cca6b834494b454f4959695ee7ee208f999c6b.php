...
<body>
<br>
<h2> <center> Edit a Student:<?php $__currentLoopData = $displayStud; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($s->SFullname); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> </center></h2>
...
<div class="row">
<div class="col">
    <form  method="POST"  action="<?php echo e(route('EditStud')); ?>">
        <?php echo csrf_field(); ?>
        <?php $__currentLoopData = $displayStud; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="SDepartment" name="SDepartment"  required>
                <option><?php echo e($s->SDepartment); ?></option>
    ...
    <br>
    <form  method="Post"  action="<?php echo e(route('AlumniStud')); ?>">
        <?php echo csrf_field(); ?>
    ...
    <br>
    <form  method="Post"  action="<?php echo e(route('DeleteStud')); ?>">
        <?php echo csrf_field(); ?>
