...
<br>
   ...
   *pick a date and after the refresh, complete the other elements*
   ...
   <form  id="formpick" >
    ...
    <label>Mode of Attend: </label>
      <select class="form-control" id="SMoA" placeholder="Enter Mode of Attend" name="SMoA">
  ...
  <option value="partTime">Part-Time</option>
    ...
    <label>First Enrty: </label>
      ...
      <button type="submit" id="pick" style="margin:10px;" class="btn btn-outline-primary">Pick Date</button>
    </div>
    </form>
    <!-- end of the form-->
